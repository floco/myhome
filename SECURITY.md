...
2. Use GitHub's private vulnerability reporting: go to the **Security** tab of this repository and click
...
This policy covers the MyHome application and its Docker image (`ghcr.io/floco/myhome`).
