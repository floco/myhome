...
When an incident does occur, it is important to report it promptly. Since this project doesn't have a dedicated report
address, please report a possible violation privately by opening a report through the repository's **Security** tab
("Report a vulnerability") — this reaches the maintainer directly and is not publicly visible. If it's easier, you may
also mention `@floco` in a GitHub Discussion, keeping details of the incident itself out of the public thread.
